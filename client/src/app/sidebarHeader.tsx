...
export default function sidebarHeader({
  ...
  const showHeader =
    pageConfig.showHeader.some((page) => pathname.startsWith(page)) &&
    !pageConfig.hideHeader.some((page) => pathname.startsWith(page));

  // Điều kiện hiện sidebar
  const showSidebar =
    !pageConfig.hideSidebar.some((page) => pathname.startsWith(page)) &&
    ...
    <>
      ...
      <div className="block md:flex w-full">
        {showSidebar && (
          <>
            <SidebarComponent
              className="mt-3 hidden md:flex md:flex-col gap-2 border-r border-gray-50 z-10 w-[200px] h-[calc(100vh)] fixed top-[66px]"
