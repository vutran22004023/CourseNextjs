    ...
    <div className="relative group rounded-xl border  hover:border-none transition-all duration-300 hover:shadow-[0_8px_16px_rgba(255,90,0,0.6)] hover:translate-y-[-8px]">
      <div className="overflow-hidden relative">
        <Image
          ...
          layout="responsive"
        />
        <div className="absolute inset-0 bg-black bg-opacity-0 rounded-t-xl group-hover:bg-opacity-50 flex items-center justify-center transition-all duration-300">
