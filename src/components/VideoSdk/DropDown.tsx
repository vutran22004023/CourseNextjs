...
import DropMIC from "@/assets/iconSvg/DropMIC";
import TestMic from "@/assets/iconSvg/TestMic";
import TestMicOff from "@/assets/iconSvg/TestMicOff";
import PauseButton from "@/assets/iconSvg/PauseButton";
      ...
      audioTags
        ...
        .then(() => {
          ...
          audioTags.item(i).addEventListener("timeupdate", () => {
            const progress =
              (audioTags.item(i).currentTime / recordingDuration) * 100;
