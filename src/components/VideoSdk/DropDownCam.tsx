...
import DropCAM from "@/assets/iconSvg/DropCAM";
import { useMeetingAppContext } from "@/context/MeetingAppProvider";

interface Props {
  webcams: any;
  changeWebcam: (value: any) => void;
}
export default function DropDownCam({ webcams, changeWebcam } :Props) {
                  ...
                  <div className="bg-gray-350 rounded-lg">
                    <div>
                      <div className="flex flex-col">
                        {webcams.map((item: any, index: any) => {
                          return (
