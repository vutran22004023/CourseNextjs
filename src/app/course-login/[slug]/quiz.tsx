...
const Quiz = ({
  ...
  return (
    <div className="items-center pl-[30px] w-full">
      <Text type="header" className="mb-[20px] flex justify-center">
        {dataVideo?.childname}
      </Text>
      <Form {...form}>
        <form
        ...
        >
          ...
          <Button type="submit" className="w-[120px] bg-[#FF5A00] hover:bg-[#ff945a]">Submit</Button>
        </form>
      </Form>
    </div>
  );
